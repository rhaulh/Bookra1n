...
class Ui_CustomMessageBoxUI(object):
    def setupUi(self, CustomMessageBoxUI):
        CustomMessageBoxUI.setObjectName("CustomMessageBoxUI")
        CustomMessageBoxUI.resize(560, 400)
        CustomMessageBoxUI.setMinimumSize(QtCore.QSize(560, 400))
        CustomMessageBoxUI.setMaximumSize(QtCore.QSize(560, 400))
        CustomMessageBoxUI.setWindowFlags(QtCore.Qt.FramelessWindowHint | QtCore.Qt.Dialog)
        CustomMessageBoxUI.setAttribute(QtCore.Qt.WA_TranslucentBackground)
        CustomMessageBoxUI.setModal(True)

        # Main container with glassmorphism effect matching main window
        self.central_widget = QtWidgets.QWidget(CustomMessageBoxUI)
        ...
        self.retranslateUi(CustomMessageBoxUI)
        QtCore.QMetaObject.connectSlotsByName(CustomMessageBoxUI)

    def retranslateUi(self, CustomMessageBoxUI):
        _translate = QtCore.QCoreApplication.translate
        CustomMessageBoxUI.setWindowTitle(_translate("CustomMessageBoxUI", "Bookra1n - Activation"))
        self.labelTitle.setText(_translate("CustomMessageBoxUI", "Activation Required"))
        self.labelInfo.setText(_translate("CustomMessageBoxUI",
            "Your device needs to be activated with a valid serial number to continue the bypass process."))
        self.btnCancel.setText(_translate("CustomMessageBoxUI", "Cancel"))
        self.btnProceed.setText(_translate("CustomMessageBoxUI", "Accept"))